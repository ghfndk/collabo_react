...
function App() {
    ...
    // 폼 유효성 검사(Form Vaildation Check) 관련 state 정의 : 입력 양식에 문제 발생시 값을 저장할 곳
                ...
                <Col md={6}>
                    <Card>
                        <Card.Body>
                            ...
                            {/*
                            !! 연산자는 어떠한 값을 강제로 boolean 형태로 변환해주는 자바스크립트 기반입니다.
                            isInvalid 속성은 해당 control의 유효성을 검사하는 속성입니다.
                            값이 ture이면 Form.Contiol.Feedback에 빨간 색상으로 오류 메시지를 보여줍니다.
                        */}
                            <Form onSubmit={SignupAction}>
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control
                                        ...
                                        isInvalid={!!errors.name} // falsy check
                                    />
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control
                                        ...
                                        required // IT에서 이용어가 나오면 필수
                                        isInvalid={!!errors.email} // falsy check
                                    />
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control
                                        ...
                                        required
                                        isInvalid={!!errors.password} // falsy check
                                    />
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control
                                        type="text"
                                        placeholder="주소을 입력해 주세요."
                                        value={address}
                                        onChange={(event) => setAddress(event.target.value)}
                                        required
                                        isInvalid={!!errors.address} // falsy check
                                    />
                                    <Form.Control.Feedback type="invalid">
                                        {errors.address}
                                    </Form.Control.Feedback>
